...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    discoverColorThemes: vi.fn().mockResolvedValue([]),
    loadColorTheme: vi.fn().mockResolvedValue(null),
    getEditorThemePreferences: vi.fn().mockResolvedValue([]),
    setTheme: vi.fn().mockResolvedValue(undefined),
    setWindowThemeColors: vi.fn().mockResolvedValue(undefined),
